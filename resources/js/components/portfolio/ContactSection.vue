        ...
        <div class="mx-auto max-w-2xl">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <a
                    ...
                    class="group flex items-center justify-center space-x-3 rounded-2xl border border-gray-700/50 bg-gray-800/50 p-6 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:border-gray-600/50 hover:bg-gray-800/70"
                >
                    <div class="rounded-xl bg-gray-700/50 p-3 transition-colors duration-300 group-hover:bg-blue-600">
                ...
                <a
                    ...
                    class="group flex items-center justify-center space-x-3 rounded-2xl border border-gray-700/50 bg-gray-800/50 p-6 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:border-gray-600/50 hover:bg-gray-800/70"
                >
                    <div class="rounded-xl bg-gray-700/50 p-3 transition-colors duration-300 group-hover:bg-purple-600">
                        <svg class="h-6 w-6 text-gray-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
            ...
            <div class="mt-8 text-center">
                <a
                    ...
                    target="_blank"
                    class="group inline-flex items-center space-x-3 rounded-2xl border border-gray-700/50 bg-gray-800/50 px-8 py-4 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:border-gray-600/50 hover:bg-gray-800/70"
                >
