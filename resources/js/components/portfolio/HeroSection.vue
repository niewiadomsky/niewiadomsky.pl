    ...
    <section class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div ref="containerRef" class="relative h-48 overflow-hidden rounded-lg md:h-96">
            ...
            >
                ...
                <div
                    class="absolute top-1/2 left-1/2 flex h-8 w-4 -translate-x-1/2 -translate-y-1/2 transform touch-none items-center justify-center rounded-full bg-white/80 shadow-sm transition-transform duration-75 hover:scale-110 active:scale-110 md:h-12 md:w-6"
                >
                    <div class="h-4 w-0.5 rounded-full bg-gray-500 md:h-6"></div>
                </div>
